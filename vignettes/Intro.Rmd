...
Install the **EchoNet2Fish** package.  If you don't already have the **devtools** package installed, you can follow the instructions at [Readme](https://github.com/krphillips/EchoNet2Fish/README.md) instead.

```{r install_package, eval=FALSE}
devtools::install_github("krphillips/EchoNet2Fish")
```
