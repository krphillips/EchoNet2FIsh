...
SELECT 
        year "Year", lake "Lake", vessel "Vessel", cruise "Cruise", op.op_id as "Op_Id", op.port as "Port", port_name as "Port_Name", transect as "Transect", target as "Target", 
        tr_design as "Tr_Design", type_set as "Type_Set", serial as "Serial", fishing_depth as "Fishing_Depth", fishing_temp as "Fishing_Temp", beg_depth as "Beg_Depth", 
        end_depth as "End_Depth", distance as "Disance", tow_time as "Tow_Time", beg_latitude_dd as "Latitude", beg_longitude_dd as "Longitude"
...
SELECT
         v.year as "Year", v.lake "Lake", v.vessel as "Vessel", v.cruise as "Cruise", v.op_id "Op_Id", op_date "Op_Date",  c.N, v.serial "Serial", v.sample_Type "Sample_Type", 
         c.species as "Species", c.weight as "Weight", c.life_Stage "Life_Stage"
